...
// removing categories can be a lengthy process
      ...
      case 'update_product':
        ...
        $sql_data_array = array('products_quantity' => (int)tep_db_prepare_input($HTTP_POST_VARS['products_quantity']),
                                ...
                                'products_height' => abs((int)tep_db_prepare_input($HTTP_POST_VARS['products_height'])),
                                'products_width' => abs((int)tep_db_prepare_input($HTTP_POST_VARS['products_width'])),
                                'products_length' => abs((int)tep_db_prepare_input($HTTP_POST_VARS['products_length'])),
